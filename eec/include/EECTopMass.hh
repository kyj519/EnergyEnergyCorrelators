// added by yeonjoon kim, mimicking  https://arxiv.org/abs/2311.02157

/*
    __________________   ______            __  ___
   / ____/ ____/ ____/  /_  __/___  ____  /  |/  /___ ___________
  / __/ / __/ / /        / / / __ \/ __ \/ /|_/ / __ `/ ___/ ___/
 / /___/ /___/ /___     / / / /_/ / /_/ / /  / / /_/ (__  |__  )
/_____/_____/\____/    /_/  \____/ .___/_/  /_/\__,_/____/____/
                                /_/
 */

#ifndef EEC_TOPMASS_HH
#define EEC_TOPMASS_HH
...
class EECTopMass : public EECBase, public hist::EECHist1D<Transform>
{
public:
    typedef EECTopMass<Transform> Self;
    ...
    // default constructor
    EECTopMass() : EECTopMass(EECConfig(), 1) {}

    // constructor taking EECConfig and Hist1D arguments
    EECTopMass(const EECConfig &config,
               unsigned nbins,
    ...
    EECTopMass(unsigned N,
               ...
               bool variance_bound = true,
               bool variance_bound_includes_overflows = true,
               bool use_general_eNc = false) : EECTopMass(EECConfig(N, norm, weight_powers, charge_powers,
    ...
    virtual ~EECTopMass() = default;

    // getter/setter options
    bool use_general_eNc() const { return use_general_eNc_; }
    void set_use_general_eNc(bool general)
    {
        use_general_eNc_ = general;
        init_subclass();
    }
    ...
    std::string description(int hist_level = 1) const
    {
        ...
        oss << std::boolalpha
            << "EECTopMass<" << EECHist::axes_description()
            << ">::" << EECBase::description() << '\n'
    ...
    bool operator!=(const EECTopMass &rhs) const { return !operator==(rhs); }
    bool operator==(const EECTopMass &rhs) const
    {
    ...
    EECTopMass &operator+=(const EECTopMass &rhs)
    {
...
private:
    ...
    void (EECTopMass::*compute_eec_func_ptr_)(const EECEvent &, int);
    ...
    void init_subclass(bool events_allowed = false)
    {
        ...
        compute_eec_func_ptr_ = &EECTopMass::eNc_sym;
        ...
        case 2:
            ...
            {
                if (!use_general_eNc_)
                    compute_eec_func_ptr_ = &EECTopMass::eec_ij_sym;
            }
            else
                compute_eec_func_ptr_ = &EECTopMass::eec_no_sym;
            break;
        ...
        case 3:
            ...
            case 3:
                if (!use_general_eNc_)
                    compute_eec_func_ptr_ = &EECTopMass::eeec_ijk_sym;
                break;

            case 2:
                compute_eec_func_ptr_ = &EECTopMass::eeec_ij_sym;
                if (!average_verts())
                    this->duplicate_histograms(2);
                break;

            case 0:
                compute_eec_func_ptr_ = &EECTopMass::eeec_no_sym;
                if (!average_verts())
                    this->duplicate_histograms(3);
                break;
        ...
        case 4:
            assert(nsym() == 4);
            if (!use_general_eNc_)
                compute_eec_func_ptr_ = &EECTopMass::eeeec_ijkl_sym;
            break;

        case 5:
            assert(nsym() == 5);
            if (!use_general_eNc_)
                compute_eec_func_ptr_ = &EECTopMass::eeeeec_ijklm_sym;
            break;

        case 6:
            assert(nsym() == 6);
            if (!use_general_eNc_)
                compute_eec_func_ptr_ = &EECTopMass::eeeeeec_ijklmn_sym;
            break;

        case 7:
            assert(nsym() == 7);
            if (!use_general_eNc_)
                compute_eec_func_ptr_ = &EECTopMass::eeeeeeec_ijklmno_sym;
            break;

        case 8:
            assert(nsym() == 8);
            if (!use_general_eNc_)
                compute_eec_func_ptr_ = &EECTopMass::eeeeeeeec_ijklmnop_sym;
            break;
            ...
            for (unsigned j = 0; j < mult; j++)
            {
                ...
                for (unsigned k = 0; k < mult; k++)
                {
                    ...
                    // should never get here
                        ...
                        throw std::runtime_error("should never get here in EECTopMass::eeec_no_sym");
                }
            }
        }
    }
    ...
    {
        ar &boost::serialization::base_object<EECBase>(*this) & boost::serialization::base_object<EECHist>(*this) & use_general_eNc_ & N_choose_2_;
