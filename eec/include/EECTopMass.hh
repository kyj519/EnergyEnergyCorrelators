...
\/_/\ \/\ \ \/\ \ \ \L\ \/\      \ \ \L\ \ \,\L\_\ \,\L\_\
   \ \ \ \ \ \ \ \ \ ,__/\ \ \__\ \ \  __ \/_\__ \\/_\__ \
    \ \ \ \ \ \_\ \ \ \/  \ \ \_/\ \ \ \/\ \/\ \L\ \/\ \L\ \
     \ \_\ \ \_____\ \_\   \ \_\\ \_\ \_\ \_\ `\____\ `\____\
      \/_/  \/_____/\/_/    \/_/ \/_/\/_/\/_/\/_____/\/_____/
...
public:
  ...
  EECTopMass(unsigned N,
                 ...
                 bool variance_bound_includes_overflows = true,
                 bool use_general_eNc = false) :
    EECTopMass(EECConfig(N, norm, weight_powers, charge_powers,
    ...
    for (unsigned i = 0; i < mult; i++) {
      ...
      for (unsigned j = 0; j < mult; j++) {
        ...
        for (unsigned k = 0; k < mult; k++) {
          ...
          else throw std::runtime_error("should never get here in EECTopMass::eeec_no_sym");
        }
      }
    }
  }
